        ...
        {navItems.map((item) => {
          ...
          return (
            ...
            >
              ...
              {/* Tooltip */}
              <div className="absolute left-[100%] ml-4 hidden group-hover:block bg-slate-900 text-white text-[10px] font-mono font-bold px-3 py-1.5 rounded-lg whitespace-nowrap shadow-lg">
                {item.name}
              </div>
            </Link>
          );
